...
public class PoolTable implements Drawable {
     ...
     * @param pc the pockets configuration for the pockets to be added to the table
     */
    public PoolTable(String colourName, double friction, long dimX, long dimY, PocketsConfig pc) {
        this.init(colourName, friction, dimX, dimY, pc);
    }
    ...
    public PoolTable(TableConfig config) {
        this.init(config.getColour(),
            ...
            config.getSizeConfig().getY(), config.getPocketsConfig());
    }

    private void init(String colourName, double friction, long dimX, long dimY, PocketsConfig pc) {
     ...
     * @param pockets The list of pockets to be added to the table
     */
