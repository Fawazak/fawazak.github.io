...
public class TableConfig implements Configurable {
     ...
     * @param pockets A pockets config instance for the pockets of the table
     */
    ...
    /**
     * Get the pockets configuration that are in the table
     * @return The Pockets configuration
     */
